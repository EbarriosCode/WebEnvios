<?php 
	...
	require_once("../../Panel-admin/model/ReporteEnviosFEGlosh_model.php");
	...
	if(isset($_GET['pagina']))
	 {
		if($_GET['pagina'] == 1)
		{
			header("Location:ReporteEnviosFEGlosh_controller.php");
		}
		else{
			$inicio = $_GET['pagina'];
	...
	require_once("../pages/ReporteEnviosFEGlosh_view.php");
 ?>