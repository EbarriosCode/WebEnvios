                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-xs-4 text-rigt">
                                    <form action="../controller/ProductosGlosh_controller.php" method="POST"><input  type="text" name="buscar" id="buscar" class="form-control"  placeholder="Ingrese cualquier dato referente al producto" onkeypress="return validateInput(event)" onpaste="return false"/>
                                </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input value="" class="form-control" onblur="this.className ='form-control campo';" type="text" id="precio" name="precio" placeholder="Precio" required onkeypress="return validateInput(event)" onpaste="return false">
                                                    <span></span>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" onblur="this.className ='form-control campo';" type="text" id="existencia" name="existencia" placeholder="Existencia" required onkeypress="return validateInput(event)" onpaste="return false">  
                                                    <span></span>
                                            </div>
