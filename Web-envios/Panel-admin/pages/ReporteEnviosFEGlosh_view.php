                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <?php foreach($reporte as $item): ?>
                                            <tr <?php  if($item['pago_cargo']==1) echo "class=danger"; ?> <?php if($item['estado_entrega']==2) echo "class=devolucion"; ?>>
                                                ...
                                                <td><a href="EnviosEditGlosh_controller.php?id=<?php echo $item['id_envio']; ?>"><button class='btn btn-success' data-toggle='modal' data-target="#modl-editar" >Editar<span class="icon-pencil"></span></button></a></td>                                          
