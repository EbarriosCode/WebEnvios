<?php 
	...
	require_once("../model/EnviosKiwiEdit_model.php");
	$obj = new EnviosEdit();
	$inst = new EnviosEdit();
	if(isset($_GET['id']))
	{
	...
	if(isset($_POST['actualizar']))
	{
		...
		if($existencia->ValidaNuevaExistencia($producto) >= $cantidad)
		{
			...
			if($editar)
			{
				...
				echo "<script>window.location.href='EnviosKiwi_controller.php'</script>";
			}
			else
			{
	...
	require_once("../view/modules/EnviosKiwiEdit_view.php");
 ?>