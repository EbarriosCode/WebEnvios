<?php 
	class EnviosEdit{
		...
		{
			$sql = "SELECT id_envio,cliente,telefono,numeroGuia,nombreDepartamento,departamento_fk,nombreProducto,producto_fk,cantidad,precio_envio,fecha,estado_entrega,pago_cargo FROM enviosglosh E INNER JOIN departamento D ON E.departamento_fk = D.id_departamento INNER JOIN productosglosh P ON E.producto_fk = P.id_producto WHERE id_envio = $id";
