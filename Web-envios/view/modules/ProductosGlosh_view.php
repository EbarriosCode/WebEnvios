                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-xs-4 text-rigt">
                                    <form action="ProductosGlosh_controller.php" method="POST"><input  type="text" name="buscar" id="buscar" class="form-control"  placeholder="Ingrese cualquier dato referente al producto"/>
                                </div>
