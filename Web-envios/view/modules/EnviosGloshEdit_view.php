...
<body>
    <div class="container">
        ...
        <div class="row">
            <form action="EnviosGloshEdit_controller.php" method="POST">
            <?php foreach($envios as $item){ ?>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="precio" name="precio" class="form-control" value="<?php echo $item['precio_envio']; ?>" onkeypress="return validateInput(event)" onpaste="return false">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-12 text-center">
                    ...
                    <a href="EnviosGlosh_controller.php" class="btn btn-warning">Cancelar y Regresar<span class="icon-reply-all"></span></a>
                </div>   
            </form>
            <?php } ?>
        </div>
